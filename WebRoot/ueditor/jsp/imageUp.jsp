...
//String propertiesPath = File.separator+"tomcat"+File.separator+"resources8383"+File.separator+"webapps"+File.separator+"ueditor"+File.separator+"config.properties";

	...
	<form action="dictionarysms/save.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td>网名:</td>
				<td>
				<!-- 1:付款成功时候 2：活动前一天 3：活动结束 4：已经退款 -->
						<select class="chzn-select" name="ds_type" id="ds_type" data-placeholder="请选择" style="vertical-align:top;width: 120px;" >
					 		<option style="text-align: center;" value="1">付款成功时候</option>
					 		<option style="text-align: center;" value="2">活动前一天</option>
					 		<option style="text-align: center;" value="3">活动结束</option>
					 		<option style="text-align: center;" value="4">已经退款</option>
					  	</select>
				</td>
			</tr>
			<tr>

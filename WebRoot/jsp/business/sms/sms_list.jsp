...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			<!-- 检索  -->
			<form action="sms/listPageSms.do"  method="post" name="smsForm" id="smsForm">
			<!-- 检索  -->
            <table>
              <tr>
                 <td>
                <span>发送状态:</span>
                <select class="chzn-select" data-placeholder="请选择" style="vertical-align:top;width: 120px;" name="sms_status" id="sms_status">

   ...
   <body>
	...
	<script type="text/javascript">
		...
		$(document).keyup(function(event){
			  if(event.keyCode ==13){
			    $("#to-recover").trigger("click");//在文档任何位置输入回车将触发登录的click事件
			  }
		});
		...
		if (window != top) {//top:返回最顶层的先辈窗口,当当前窗口不是顶层窗口时，将当前页面在最顶层窗口打开
